...
public class TestFreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_test_free, container, false);
    ...
    private void updateFragment(){
        if (index == 63){
            DialogFragment dialog = Dialog.newInstance(errNums, 3);
